...
\pgfdeclareimage[height=6cm]{test1.2}{figures/13-16zona2.pdf}
\pgfdeclareimage[height=6cm]{test1.3}{figures/13-16zona3.pdf}
\pgfdeclareimage[height=6cm]{test2.2}{figures/17-20zona2.pdf}
\pgfdeclareimage[height=6cm]{test2.3}{figures/17-20zona3.pdf}
\pgfdeclareimage[height=6cm]{test3.2}{figures/21-23zona2.pdf}
\pgfdeclareimage[height=6cm]{test3.3}{figures/21-23zona3.pdf}
...
\begin{frame}
  ...
  \item<1-> Feixes de infra-vermelhos para detectar entradas e saídas de pessoas
	\begin{itemize}
  		\item<2-> Curto alcance que é simultaneamente emissor e receptor
